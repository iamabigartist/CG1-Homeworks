...
public:
	...
	Vector3f sample_direction_ideal_diffusion ( const Interaction& interact );
	Vector3f sample_direction_ideal_specular ( const Interaction& interact );
	bool sample_direction_ideal_transmission ( const Interaction& interact, float ior, V3& wi );
};
